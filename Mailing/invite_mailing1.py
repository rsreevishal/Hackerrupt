...
emailArray=['aravind1998@gmail.com','712sandhya@gmail.com','sarjhur@gmail.com','subhi.dev13@gmail.com','barathgopi1699@gmail.com','palaniappan719@gmail.com']
...
for i in range(0,iterationLength):
    ...
    body="Hello fellow peers,\n\n The Association of Computer Engineers of the Computer Science Department of Sri Venkateswara College of Engineering is proud to announce it’s first-ever hackathon – Hackerrupt’20.\n\n Hackerrupt’20 is our maiden venture into finding young minds and presenting them with the right platform where they can showcase their talents and ideas across various domains of the computer world.\n\nThe hackathon of 24 hours will be conducted at the Guvi Geek Network Pvt. Ltd. workspace at the IITM Research Park on the 21st and 22nd of March,2020. The participants will be shortlisted after an initial selection process. Compete in our 24-hr warfare and stand a chance to win exciting internship opportunities and exclusive goodies. Give in your active participation and take away total prize pool worth 50k.\nWe plan on making this event a wonderful experience for all participants to cultivate their skills and build on their dream projects all the while having the best of their times at our hackathon.\nFor further details, please visit the website www.hackerrupt.in.\n\nThanks and Regards,\nTeam ACE-Hackkerupt’20\nSVCE, CSE"
